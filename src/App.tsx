    ...
    <main>
      <section className="hero-section">
        ...
        <div id="top" className="hero-content">
          <p className="eyebrow">Computer lessons, builds, and programming foundations</p>
          <h1>Hazy Forge Academy</h1>
          <p className="lede">
            Practical computer teaching for students of all ages, from what a
            computer is to building one, using a terminal, and shipping a first
            real website.
          </p>
      ...
      <section className="signal-strip" aria-label="Teaching approach">
        {["One-on-one or small group", "Real machines, real projects", "Beginner-safe pace"].map(
          (item) => (
      ...
      <section id="programs" className="section programs-section">
        <div className="section-heading">
          <p className="eyebrow">Start concrete, then level up</p>
          <h2>Lesson paths that turn curiosity into usable skill.</h2>
        </div>
      ...
      <section id="format" className="section split-section">
        <div>
          ...
          <h2>Students, families, and adults who want computers to feel less mysterious.</h2>
      ...
      <section className="section advanced-band">
        <div>
          ...
          <h2>Beyond basics, the track can move into modern software work.</h2>
        </div>
        <p>
          Once the fundamentals are solid, students can graduate into React,
          Python, automation, APIs, AI tooling, Linux servers, and deployment,
          using the same shipping mindset behind Hazy Forge client work.
        </p>
      </section>
      ...
      <section id="contact" className="section contact-section">
        <div>
          ...
          <p>
            ...
            one thing they want to build or understand.
          </p>
        </div>
